       ...
       {/*  <div className="grid md:grid-cols-3 gap-12 mb-16">
          <div className="group">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-2xl font-bold text-gray-900">evmscan.org</h3>
            </div>
            <p className="text-gray-600 mb-6 leading-relaxed">
              Open source blockchain explorer for local EVM development. Built
              with modern web technologies and developer experience in mind.
            </p>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
          ...
          <div className="flex items-center space-x-6 mt-4 md:mt-0">
            ...
            <div className="flex items-center space-x-1">
              ...
              <Heart
                className="h-3 w-3 text-red-500 animate-pulse mx-1"
                fill="currentColor"
              />
        ...
        <div
          className="absolute bottom-20 left-10 w-2 h-2 bg-gray-300 rounded-full opacity-30 animate-pulse"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute top-1/2 right-1/4 w-3 h-3 border border-gray-300 rounded opacity-20 animate-pulse"
